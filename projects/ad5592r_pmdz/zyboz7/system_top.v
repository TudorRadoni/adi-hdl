...
// 4. Add SPI ports for both ADC PMOD connector and sniffing PMOD connector 
  ...
  output          adc_spi_cs_sniff,
  output          adc_spi_sclk_sniff,
  output          adc_spi_mosi_sniff,
  output          adc_spi_miso_sniff
);
...
// 2. Connect the PWM wires to the input port of the ad_iobuf
    .dio_i ({ pwm_led_3,
              ...
              pwm_led_0 }),
    .dio_o (gpio_i[7:4]),
    .dio_p (led)); // led[3:0] are the output ports of the ad_iobuf, hence the order in dio_i
...
// 6. Clone the ADC SPI port to the sniffing ports 
  ...
  assign adc_spi_cs_sniff   = adc_spi_cs;
  assign adc_spi_sclk_sniff = adc_spi_sclk;
  assign adc_spi_mosi_sniff = adc_spi_mosi;
  assign adc_spi_miso_sniff = adc_spi_miso;
  ...
  system_wrapper i_system_wrapper (
    ...
    .gpio_o (gpio_o),
    .spi0_clk_i (),
    .spi0_clk_o (adc_spi_sclk), // 5. Connect here the SPI SCLK
